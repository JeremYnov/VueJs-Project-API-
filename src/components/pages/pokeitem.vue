        ...
        <div class="item-content-container">
            ...
            <div id="filter" class="item-filter">
                <div class="item-filter-container">
                    ...
                    <div class="item-page">
                        <router-link to="/pokedex/1"><a><img src="assets/icons/icons8-pokédex-50.png" alt="">Pokédex</a></router-link>
                    </div>
                </div>
            </div>
            ...
            <div class="item-container">
                ...
                <div class="item-wrapper">
                    <div v-on:click="url(value.id)" v-for="(value, index) in infoItem" :key="index" class="item">
